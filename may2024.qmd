...
prepoll2019 <- prepoll2019 %>%
  select(RegulatedEntityName, RegulatedEntityType, Value, AccountingUnitName, DonorName, DonorStatus, ReceivedDate, ReportedDate, ReportingPeriodName, NatureOfDonation)
