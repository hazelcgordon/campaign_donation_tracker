...
prepoll2019 <- prepoll2019 %>%
  select(RegulatedEntityName, RegulatedEntityType, Value, AccountingUnitName, DonorName, DonorStatus, ReceivedDate, ReportingPeriodName)
...
kable(reporting_freq, 
      col.names = c("", "Pre-Poll 1", "Pre-Poll 2", "Pre-Poll 3", "Pre-Poll 4", "Pre-Poll 5", "Pre-Poll 6", "Q4 2019"), 
      align = 'c') %>%
  kable_styling(full_width = FALSE) %>%
  column_spec(1, width = "6cm") %>%
  add_header_above(c(" " = 1, "Donation classification" = ncol(reporting_freq) - 1), bold = TRUE) %>%
