...
q1 <- read.csv("jan_may_2024.csv")

#select relevant variables, extract month out of date

q1 <- q1 %>%
  select(RegulatedEntityName, RegulatedEntityType, RegulatedDoneeType, Value, ReceivedDate, DonorStatus, AccountingUnitName) %>%
...
### What kind of donee's have recieved the most money?
