...
The table below summarises totals for week one and two, split by 2019 and 2024.
...
ggplot(pptotal, aes(x = interaction(RegulatedEntityName, ReportingPeriodName), y = Value, fill = DonorStatus)) +
  geom_bar(stat = "identity") +
  labs(x = "", y = "", fill = "Donor Type") +
  theme_minimal() +
