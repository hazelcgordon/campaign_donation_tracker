...
female_neutral1 <- c("Jo Hart", "Alex Baker", "Lesley Ann Taylor", "Jo White", "Tracy Kelly", "Ash Jones", "Jo Bird", "Gita Gordon", "Ali Griffiths", "Alex Fawbert", "Naz Shah", "Gill Leek", "Valerie Gray", "Kerry McCarthy", "Jai Breitnauer", "Sam Ammar", "Jo Stevens", "Meg Shepherd-Foster", "Tracey Hague", "Gill Westcott", "Kay Lauer", "Gill German", "Kay Wesley", "Lesley Backhouse", "Mags Hall", "Sam Casey-Rerhaye", "Tracey Little", "Alex Mayer", "Tracy Gilbert", "Jo Mowat", "Jo Phillips", "Mel Dawkins", "Pat Cullen", "Lesley Rollings")

#MALE NEUTRAL NAMES

male_neutral1 <- c("Charlie Abel", "Graeme Craib", "Kenny MacAskill", "Alex Stevenson", "Chris Philipsborn", "Lee Anderson", "Lee Alan Huntbach", "Chris Nevile", "Robin Millar", "Alex Harrison", "Ray Saint", "Jamie McNamee", "Francis Chubb", "Joe Taylor", "Ryan North", "Ryan Warren", "Gerry Carroll", "Eóin Millar", "Ray Georgeson", "Reggie Adams", "Chris Collin", "Tahir Ali", "Qasim Mohammed Esak", "Lee Dargue", "Rhys Burriss", "Sam Rushworth", "Jamie McGowan", "Chris Webb", "Nick Smith", "Chris Green", "Joe Salmon", "Alex Burghart", "Robin Tilbrook", "Chris Elmore", "Ashley Fox", "Leigh Redman", "Charlie Dewhirst", "Chris Ward", "Ashley Ridley", "Nick Belfitt", "Ray Brady", "Christian Wakeford", "Chris Evans", "Lindsay Whittle", "Jamie Stone", "Lee Canning", "Sam Coates", "Alex Wilson", "Alex Barros-Curtis", "Elliot Colburn", "Ashley Dickenson", "Mel Stride", "Tristan Osborne", "Alex Chalk", "Max Wilkinson", "Chris Chilton", "Nick Brown", "Chris Brody", "Nic Puntis", "Lindsay Hoyle", "Robin Adamson", "Sasha Jolliffe Yasawi", "Lee Lavery", "Jamie Orange", "Drew Thomas Gilchrist", "Lee Barron", "Lee Forster", "Chris Lofts", "Lee Daniel Gibbs", "Chris Philp", "Billy Ross", "Sam Holland", "Lee Stranders", "Jamie Mulhall", "Joe Naitta", "Sam Ward", "Chris Williamson", "Nick Allen", "Lee Pitcher", "Chris Coghlan", "Ashley James Payne", "Chris Tough", "Sam Bastow", "Chris Law", "Naz Anis-Miah", "Ryan Blackadder", "Graeme Downie", "Danny Smith", "Les Beaumont", "Sam Habeeb", "Joe Bhangu", "Tahir Maher", "Danny Donnelly", "Sammy Wilson", "Tahir Mirza", "Chris Scott", "Jai Singh", "Danny Kruger", "Chris Murray", "Alex Martin", "Cameron Rose", "Nick Hornig", "Lee Evans", "Charlie Davis", "Sam Gabriel", "Christian Hacking", "Ryan Coogan", "Chris Dey", "Lee Bunker", "Toni Giugliano", "Alex Just", "Alex Deane", "Chris McFarling", "Robin Moss", "Pat O'Connor", "Chris Sermanni", "Nick Durie")

# UNKNOWN

unknown_neutral <- c("Terry Robinson", "Jamie Pullin", "Chris Moore", "Jamie Alan Hinton-Wardle", "Charlie Caiger", "Kris Stone", "Chris Baddon", "Robin Burnham", "Gerry Cullen")
