...
gender_check <- name %>%
  mutate(gender = case_when(
    first_name %in% male_names1 ~ "male",
    first_name %in% male_names2 ~ "male",
    first_name %in% male_names3 ~ "male",
    first_name %in% male_names4 ~ "male",
    first_name %in% male_names5 ~ "male",
    first_name %in% female_names1 ~ "female",
    first_name %in% female_names2 ~ "female",
